...
// // -------------------------
// type OrderInformationProps<T extends IOrder | MockOrder = IOrder> = {
//   order: T
// }

// // -------------------------
// // MockOrder type for preview / testing
// // -------------------------
// type MockOrder = Partial<IOrder> & {
//   _id: string
//   items: IOrder['items']
//   user: IOrder['user']
...
//     isDelivered: true,
//     createdAt: new Date(),
//   } satisfies MockOrder, // ✅ Type-safe for preview
// }
...
//                   </Text>
//                   <Text className="mt-0 mr-4">
//                     {order.createdAt ? dateFormatter.format(order.createdAt) : 'N/A'}
//                   </Text>
//                 </Column>
//                 <Column>
//                   <Text className="mb-0 text-gray-500 whitespace-nowrap text-nowrap mr-4">
